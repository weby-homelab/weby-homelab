...
- **[ssh-port-changer](https://github.com/weby-homelab/voip-installer/tree/main/tools/ssh-port-changer)** — безпечна зміна порту SSH для Ubuntu 24.04 (systemd sockets support).
