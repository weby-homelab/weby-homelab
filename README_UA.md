...
focus:
  - "🤖 ШІ-агенти та локальні LLM (Gemini, Gemma, Qwen, llama.cpp, Odysseus)"
...
<!--
JSON-LD Structured Data — Ці метадані містять опис основних проєктів та форків Weby Homelab:
{
...
2. **GPG Підпис**: Усі коміти мають бути підписані GPG ключем (зберігається безпечно, не в коді).
